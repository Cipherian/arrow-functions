...
let objectLitArrow = (key1,key2, key3) => {
  return {
    key1: 'value1',
    key2: 'value2',
    key3: 'value3',
...
const StudentArrow = (name, age, hometown) => {
  this.name = name;
  this.age = age;
  this.hometown = hometown;
}
...
// let joe2 = new StudentArrow('Joe', 'Schmoe', 100);
...
//They do not work with constructor functions!
...
// It is the properties of our object 'joe'
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" in scopeArrow is the global variable Window which contains many of the default functions.
// 3. Explain why "this" is different when an arrow function is used.
// This in an arrow function calls on the parent scope and does not work properly with constructors or prototypes.
